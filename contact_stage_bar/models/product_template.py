...
class ProductTemplate(models.Model):
    ...
    def _igi_build_vals(self, data):
        ...
        _set('fluorescence_intensity', data.get('fluorescence_intensity') or data.get('fluorescence'))
        _set('fluorescence_color',     data.get('fluorescence_color'))
        _set('treatments',             data.get('treatment'))
