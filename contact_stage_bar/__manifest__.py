{
    ...
    "data": [
        ...
        'security/lgd_accounting_access.xml',
        'security/lgd_audit_rules.xml',
        'data/lgd_ops_reason_data.xml',
        ...
        "views/stone_replacement_views.xml",
        ...
        "views/lgd_logistics_views.xml",
        "views/lgd_qc_views.xml",
        "views/lgd_procurement_commit_views.xml",
